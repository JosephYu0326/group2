...
if ($totalRows) {
    ...
    if ($page > $totalPages) {
        header("Location: Blog_category.php?page=$totalPages");
        exit;
    }
                    ...
                    <form name="cateForm" method="post" onsubmit="checkForm(); return false;">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="thema" id="thema" require>
                                <div style="color:red" class="form-text"></div>
                            </div>
                            <div class="form-group">
                                <label for="squence">排序</label>
                                <input type="number" class="form-control" name="squence" id="squence">
                                <div style="color:red" class="form-text"></div>
                            </div>
                        </div>
...
<script>
    ...
    function checkForm() {
        ...
        if (isPass) {
            ...
            fetch('Blog_category_add-api.php', {
                    method: 'POST',
                    body: fd
                }).then(r => r.json())
                .then(obj => {
