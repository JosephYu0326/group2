                    ...
                    <div class="card-body">
                        ...
                        <form name="form2" method="post" novalidate onsubmit="checkForm(); return false;">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="board_article_id" name="board_article_id" required value="<?= htmlentities($row['board_article_id']) ?>">
                                <div class="form-text"></div>
                            </div>

                            <div class="mb-3">
                                <label for="parentid" class="form-label">*ParentId</label>
                                <input type="text" class="form-control" id="parentid" name="parentid" required value="<?= htmlentities($row['parentid']) ?>">
                                <div class="form-text"></div>
                            </div>
